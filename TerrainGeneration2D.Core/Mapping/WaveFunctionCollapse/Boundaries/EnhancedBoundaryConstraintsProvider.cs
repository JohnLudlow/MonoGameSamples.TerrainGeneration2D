...
public class EnhancedWfcProvider : WfcProvider
{
  ...
  /// <param name="wfcConfig">Additional WFC configuration settings.</param>
  ...
  public EnhancedWfcProvider(
      ...
      : base(width, height, tileRegistry, randomProvider, config, heightProvider, chunkOrigin, wfcConfig != null ? wfcConfig.Weights : throw new ArgumentNullException(nameof(wfcConfig)), wfcConfig.Heuristics)
  {
  ...
  // Methods that do not access instance data can be marked as static
