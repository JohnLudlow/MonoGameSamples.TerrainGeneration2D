...
4. **Follow how each chunk is born, cached, and saved.**
   ...
   - The WFC constraints depend on the tile types defined in [`TerrainGeneration2D.Core/Mapping/TileTypes/TileType.cs`](../TerrainGeneration2D.Core/Mapping/TileTypes/TileType.cs) and the threshold-driven materials described in [`TerrainGeneration2D.Core/Mapping/TileTypes/TileTypeRuleConfiguration.cs`](../TerrainGeneration2D.Core/Mapping/TileTypes/TileTypeRuleConfiguration.cs).
