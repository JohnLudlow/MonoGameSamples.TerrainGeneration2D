...
2. Add generated Gum runtime files to the MonoGame Content project
   ...
   - Follow the MonoGame Content Builder guidance: https://docs.monogame.net/articles/getting_started/content_pipeline/content_builder_project.html?tabs=vscode
